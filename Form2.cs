...
namespace Verde_Supermarket
{
    public partial class Form2 : Form
    {
        ...
        public Form2(string userName, string orderNumb)
        {
            InitializeComponent();
            Instance = this;
        ...
        {  //Opens the dairy form
            Form3 form = new Form3(userName, orderNumb);
            form.Show();
            Visible = false;
        }
        ...
        {   //opens the Bakery form
            Form4 form = new Form4(userName, orderNumb);
            form.Show();
            Visible = false;
        }
        ...
        {  //Opens the Vegtables form
            Form5 form = new Form5(userName, orderNumb);
            form.Show();
            Visible = false;
        }
        ...
        {   //Opens the Fruit form
            Form6 form = new Form6(userName,orderNumb);
            form.Show();
            Visible = false;
        }
        ...
        {  //Opens the Meat form
            Form7 form = new Form7(userName, orderNumb);
            form.Show();
            Visible = false;
        }
        ...
        {   //Opens the Snack form
            Form8 form = new Form8(userName, orderNumb);
            form.Show();
            Visible = false;
        ...
        {  //Opens the prevouis orders form
            Form9 form = new Form9(userName, orderNumb);
            form.Show();
            Visible = false;
